        ...
        <form className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="bg-transparent border border-white/10 px-4 py-2.5 rounded-lg text-textMain placeholder:text-textMuted outline-none focus:ring-2 focus:ring-accentViolet focus:border-accentViolet transition"
            />
          </div>
